...
function Footer() {
  return (
    <footer className="border-t py-12 pl-30">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        ...
        <form className="flex">
            <input 
                ...
                focus:outline:none focus:ring-2 focus:ring-gray-500 transition-all"
                    required />
           <button type="submit" className="bg-black  px-6 py-3  text-white text-sm rounded-r-md 
        ...
        <div>
            ...
            <ul className="space-y-2 text-gray-600">
                <li>
                    <Link to="#" className="hover:text-gray-700 tansition-colors">
                    Men's Top Wear
                    </Link>
                </li>
                <li>
      ...
      <div className="container mx-auto mt-12">
        <p className="text-gray-500 text-smtracking-tighter text-center">
