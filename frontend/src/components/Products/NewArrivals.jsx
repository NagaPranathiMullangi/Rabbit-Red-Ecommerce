  ...
  return (
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto text-center mb-10 relative">
        ...
        <div
          ref={scrollRef}
          className={`container mx-auto overflow-x-auto scroll-smooth flex space-x-6 relative ${
          ...
          {newArrivals.map((product) => (
            <div
              ...
              {/* 👇 Entire clickable card inside Link */}
              <Link to={`/product/${product._id}`} className="block">
                <img
                  ...
                  draggable="false"
                />
                <div className="absolute bottom-0 left-0 backdrop-opacity-30 backdrop-blur-sm text-white text-left p-4 rounded-b-lg w-full">
